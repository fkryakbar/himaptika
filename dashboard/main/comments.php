                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="email" id="nama" class="form-control" value="" id="exampleFormControlInput1">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="komen" id="exampleFormControlTextarea1" rows="3"></textarea>
                            </div>
                        </div>
    ...
    <script>
        ...
        function hapus(id) {
            Swal.fire({
                ...
                text: "Komentar tidak dapat dikembalikan",
                icon: 'warning',
        ...
        const isimodal = document.querySelector(".modal-content")
        ...
        edit.forEach(function(btn) {
            btn.addEventListener("click", function() {
                ...
                ajax.onreadystatechange = function() {
                    if (ajax.readyState == 4 && ajax.status == 200) {
                        isimodal.innerHTML = ajax.response
                    }
                }
                ajax.open("get", `admin.php?getkomen=${btn.dataset.id}`)
                ajax.send()
        ...
        function simpan(id) {
            ...
            ajax.open("get", `admin.php?id=${id}&nama=${nama.value}&link=${link.value}&komen=${komen.value}`)
            ajax.send()
